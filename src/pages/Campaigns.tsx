...
import { Megaphone } from "lucide-react"; // Using Megaphone icon for Campaigns
      ...
      <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm p-6">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Plan, execute, and track your marketing campaigns here.
          </p>
          {/* Future: Add campaign listing, creation, editing, and performance tracking */}
        </div>
      </div>
    </Layout>
  );
